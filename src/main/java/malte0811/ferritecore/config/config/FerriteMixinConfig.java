package malte0811.ferritecore.config.config;
...
public abstract class FerriteMixinConfig implements IMixinConfigPlugin {
    ...
    protected enum LithiumSupportState {
        ...
        private boolean shouldApply() {
            switch (this) {
                default: case NO_CONFLICT: return true;
                case INCOMPATIBLE: return !HAS_LITHIUM;
                case APPLY_IF_ROADRUNNER: return !HAS_LITHIUM || HAS_ROADRUNNER;
            }
        }
    }
}
